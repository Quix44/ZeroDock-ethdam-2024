...
.from-\[\#550097\] {
  --tw-gradient-from: #550097 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(85 0 151 / 0) var(--tw-gradient-to-position);
...
:root {
  ...
  --background: 274 57.85% 5.28%;
  --foreground: 274 8.9% 98.3%;

  --muted: 274 44.5% 19.8%;
  --muted-foreground: 274 8.9% 56.6%;

  --popover: 274 47.2% 8.58%;
  --popover-foreground: 274 8.9% 98.3%;

  --card: 274 47.2% 8.58%;
  --card-foreground: 274 8.9% 98.3%;

  --border: 274 44.5% 19.8%;
  --input: 274 44.5% 19.8%;

  --primary: 274 89% 66%;
  --primary-foreground: 274 8.9% 6.6000000000000005%;

  --secondary: 274 44.5% 19.8%;
  --secondary-foreground: 274 8.9% 98.3%;

  --accent: 274 44.5% 19.8%;
  --accent-foreground: 274 8.9% 98.3%;

  --destructive: 0 62.8% 30.6%;
  --destructive-foreground: 274 8.9% 98.3%;
